...
content_types = ["food", "medicine", "bebida"]
...
def setup_location_coords(options):
    ...
    # Calcular los costos de vuelo entre todas las combinaciones de localizaciones
...
def main():
    ...
    location_coords, flight_costs = setup_location_coords(options)
