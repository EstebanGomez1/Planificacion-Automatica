...
class Method0 extends Method
{
	...
	TaskList createTaskList0()
	{
		...
		retVal.subtasks[3] = new TaskList(new TaskAtom(new Predicate(0, 7, new TermList(TermVariable.getVariable(3), new TermList(TermVariable.getVariable(6), new TermList(TermVariable.getVariable(5), TermList.NIL)))), false, true));
