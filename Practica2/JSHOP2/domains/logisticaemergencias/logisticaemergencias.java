...
class Precondition1 extends Precondition
{
	...
	public Precondition1(Term[] unifier)
	{
		...
		p[2] = new PreconditionAtomic(new Predicate(0, 4, new TermList(TermVariable.getVariable(1), TermList.NIL)), unifier);
		p[3] = new PreconditionAtomic(new Predicate(1, 4, new TermList(TermVariable.getVariable(3), TermList.NIL)), unifier);
		p[4] = new PreconditionAtomic(new Predicate(4, 4, new TermList(TermVariable.getVariable(2), TermList.NIL)), unifier);
		p[5] = new PreconditionAtomic(new Predicate(5, 4, new TermList(TermVariable.getVariable(0), TermList.NIL)), unifier);
		p[6] = new PreconditionAtomic(new Predicate(2, 4, new TermList(TermVariable.getVariable(1), new TermList(TermVariable.getVariable(3), TermList.NIL))), unifier);
		p[7] = new PreconditionAtomic(new Predicate(6, 4, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(3), TermList.NIL))), unifier);
		b = new Term[8][];
		b[0] = unifier;
		b[0] = Term.merge( b, 1 );
...
class Operator1 extends Operator
{
	public Operator1()
	{
		...
		delIn[0] = new DelAddAtomic(new Predicate(5, 4, new TermList(TermVariable.getVariable(0), TermList.NIL)));
		delIn[1] = new DelAddAtomic(new Predicate(6, 4, new TermList(TermVariable.getVariable(1), new TermList(TermVariable.getVariable(3), TermList.NIL))));
		delIn[2] = new DelAddAtomic(new Predicate(7, 4, new TermList(TermVariable.getVariable(1), new TermList(TermVariable.getVariable(2), TermList.NIL))));

		setDel(delIn);

		DelAddElement[] addIn = new DelAddElement[1];
		addIn[0] = new DelAddAtomic(new Predicate(8, 4, new TermList(TermVariable.getVariable(1), new TermList(TermVariable.getVariable(2), new TermList(TermVariable.getVariable(0), TermList.NIL)))));
...
class Precondition3 extends Precondition
{
	...
	public Precondition3(Term[] unifier)
	{
		...
		p[1] = new PreconditionAtomic(new Predicate(11, 7, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(1), TermList.NIL))), unifier);
		p[2] = new PreconditionAtomic(new Predicate(7, 7, new TermList(TermVariable.getVariable(2), new TermList(TermVariable.getVariable(3), TermList.NIL))), unifier);
		p[3] = new PreconditionAtomic(new Predicate(5, 7, new TermList(TermVariable.getVariable(4), TermList.NIL)), unifier);
		p[4] = new PreconditionAtomic(new Predicate(6, 7, new TermList(TermVariable.getVariable(4), new TermList(TermVariable.getVariable(5), TermList.NIL))), unifier);
		p[5] = new PreconditionAtomic(new Predicate(2, 7, new TermList(TermVariable.getVariable(2), new TermList(TermVariable.getVariable(6), TermList.NIL))), unifier);
		b = new Term[6][];
		b[0] = unifier;
		b[0] = Term.merge( b, 1 );
...
class Method0 extends Method
{
	...
	TaskList createTaskList0()
	{
		...
		retVal.subtasks[0] = new TaskList(new TaskAtom(new Predicate(1, 7, new TermList(TermVariable.getVariable(4), new TermList(TermVariable.getVariable(2), new TermList(TermVariable.getVariable(3), new TermList(TermVariable.getVariable(6), TermList.NIL))))), false, true));
...
class Precondition4 extends Precondition
{
	...
	public Precondition4(Term[] unifier)
	{
		...
		p[2] = new PreconditionAtomic(new Predicate(8, 7, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(1), new TermList(TermVariable.getVariable(2), TermList.NIL)))), unifier);
		...
		p[4] = new PreconditionAtomic(new Predicate(13, 7, new TermList(TermVariable.getVariable(4), new TermList(TermVariable.getVariable(5), TermList.NIL))), unifier);
		p[5] = new PreconditionAtomic(new Predicate(12, 7, new TermList(TermVariable.getVariable(2), new TermList(TermVariable.getVariable(6), TermList.NIL))), unifier);
		p[6] = new PreconditionAtomic(new Predicate(11, 7, new TermList(TermVariable.getVariable(4), new TermList(TermVariable.getVariable(6), TermList.NIL))), unifier);
		b = new Term[7][];
		b[0] = unifier;
		b[0] = Term.merge( b, 1 );
...
class Method1 extends Method
{
	public Method1()
	{
		super(new Predicate(1, 7, TermList.NIL));
		TaskList[] subsIn = new TaskList[2];
	...
	TaskList createTaskList0()
	{
		...
		retVal.subtasks[0] = new TaskList(new TaskAtom(new Predicate(0, 7, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(3), new TermList(TermVariable.getVariable(5), TermList.NIL)))), false, true));
		retVal.subtasks[1] = new TaskList(new TaskAtom(new Predicate(2, 7, new TermList(TermVariable.getVariable(2), new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(1), new TermList(TermVariable.getVariable(6), new TermList(TermVariable.getVariable(4), new TermList(TermVariable.getVariable(5), TermList.NIL))))))), false, true));
		retVal.subtasks[2] = new TaskList(new TaskAtom(new Predicate(1, 7, TermList.NIL), false, false));
...
class Precondition5 extends Precondition
{
	...
	public Precondition5(Term[] unifier)
	{
		...
		p[3] = new PreconditionAtomic(new Predicate(11, 5, new TermList(TermVariable.getVariable(2), new TermList(TermVariable.getVariable(3), TermList.NIL))), unifier);
		b = new Term[4][];
		b[0] = unifier;
		b[0] = Term.merge( b, 1 );
...
class Method2 extends Method
{
	public Method2()
	{
		super(new Predicate(2, 5, TermList.NIL));
		TaskList[] subsIn = new TaskList[2];
	...
	TaskList createTaskList0()
	{
		...
		retVal.subtasks[0] = new TaskList(new TaskAtom(new Predicate(0, 5, TermList.NIL), false, false));
		retVal.subtasks[1] = new TaskList(new TaskAtom(new Predicate(1, 5, TermList.NIL), false, false));
		retVal.subtasks[2] = new TaskList(new TaskAtom(new Predicate(0, 5, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(4), new TermList(TermVariable.getVariable(1), TermList.NIL)))), false, true));
		retVal.subtasks[3] = new TaskList(new TaskAtom(new Predicate(2, 5, TermList.NIL), false, false));
